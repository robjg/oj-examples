...
public class AnnotationsInJobTest {

    private static final Logger logger = LoggerFactory.getLogger(AnnotationsInJobTest.class);

    @Test
    public void annotationsExample() throws FailedToStopException {
        ...
        assertThat(lines[1], containsString("annotations.xml"));
        ...
        assertThat(lines[5], containsString("annotations.xml"));
